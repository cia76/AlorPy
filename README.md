...
1. Если не установлены библиотеки **pytz**, **requests**, **websockets**, то установите их, например, через **pip install <библиотека>**. Также можно установить сразу все библиотеки через **pip install -r requirements.txt**
