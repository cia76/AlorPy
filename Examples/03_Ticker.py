...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    exchange = 'MOEX'  # Биржа
    symbol = 'SBER'  # Тикер
    # symbol = 'SiU3'  # Тикер можно искать по короткому имени. Для фьючерсов: <Код тикера><Месяц экспирации: 3-H, 6-M, 9-U, 12-Z><Последняя цифра года>
    # symbol = 'SI-9.23'  # Формат полного имени для фьючерсов: <Код тикера заглавными буквами>-<Месяц экспирации: 3, 6, 9, 12>.<Последние 2 цифры года>
    # symbol = 'RIU3'
    # symbol = 'RTS-9.23'
